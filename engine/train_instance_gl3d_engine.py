"""Training engine: Instance Metric Learning on GL3D (new pipeline)
...
from src.utils.callbacks import CustomRichModelSummary, CustomRichProgressBar, DatamoduleSummary
